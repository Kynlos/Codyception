...
function removeDuplicates($conn)
{
    try {
        ...
        // Handle error
        $error = "Error removing duplicate entries: " . $e->getMessage();
    }
}
...
<head>
    ...
    <style>
        ...
        .save-button:hover::after {
            content: "Must Be Logged In to Save";
            position: absolute;
            top: calc(100% + 5px);
            left: 50%;
        ...
        main {
            padding-top: 20rem; /* Adjust this value to match the height of your navbar */
        }
    </style>
            ...
            <div class="flex items-center justify-between">
                ...
                <!--<a href="https://donate.stripe.com/aEU28ja9qeCRc6ceUU" target="_blank" class="bg-blue-500 hover:bg-blue-600 text-white px-4 py-2 rounded-md transition-colors duration-300 mr-4">
                    ...
                    <?php if (!isset($_SESSION['user_id'])): ?>
                        <a href="public.php" class="mx-2 text-gray-600 hover:text-gray-800 font-bold"><i class="fas fa-list"></i> Browse</a>
                        ...
                        <a href="public.php" class="mx-2 text-gray-600 hover:text-gray-800 font-bold"><i class="fas fa-folder-open"></i> Browse</a>
