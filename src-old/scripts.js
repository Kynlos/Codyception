...
function openPromptCreationGuideModal() {
    var modal = document.getElementById('promptCreationGuideModal');

    // Check if the modal element is found
    if (modal) {
        modal.style.display = 'block';
    } else {
        console.error('Modal element not found. Ensure the element ID is correct.');
    }

    openCustomCommandViewerModal(); // Add this line to open the customCommandViewerModal
}
